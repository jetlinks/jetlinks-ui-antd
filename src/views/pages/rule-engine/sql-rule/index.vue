<template>
  <page-container title="数据转发">
    <BaseCrud @event-change="eventChange" :form-data="formData" @modal-change="modalChange" @modal-visible="modalVisible" :model="model" :columns="columns" title="数据转发列表" :formPar="FormPar" :service="service" :default-params="defaultParams">
      <template #extra>
        <a-space>
      ...
      <template #state="slotProps">
        <template v-if="slotProps.value.value === 'stopped'">
...
export default defineComponent({
  ...
  setup () {
    const service = new BaseService<UserItem>('rule-engine/instance')
    const columns = [
      {
        title: 'ID',
        dataIndex: 'id',
