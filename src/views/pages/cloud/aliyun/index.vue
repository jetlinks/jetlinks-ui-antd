<template>
  <page-container title="阿里云">
    <BaseCrud @event-change="eventChange" :form-data="formData" @modal-change="modalChange" @modal-visible="modalVisible" :model="model" :columns="columns" title="阿里云列表" :formPar="FormPar" :service="service" :default-params="defaultParams">
      <template #extra>
        <a-space>
...
export default defineComponent({
  ...
  setup () {
    const service = new BaseService<UserItem>('device/aliyun/bridge')
    const columns = [
      {
        title: 'ID',
        dataIndex: 'id',
