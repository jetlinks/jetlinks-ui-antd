export default {
  ...
  'pages.system.tenant.member': '成员',
  'pages.system.tenant.tenantMember': '租户成员',
  'pages.system.tenant.cancel': '取消选择',
  'pages.system.tenant.binds': '批量绑定',
  'pages.system.tenant.unbinds': '批量解绑',
  'pages.system.tenant.bindUser': '绑定用户',
  'pages.system.tenant.addUser': '添加用户',
  'pages.system.tenant.administrator': '管理员',
