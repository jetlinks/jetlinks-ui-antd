...
const SearchComponent = <T extends Record<string, any>>({ field, onSearch, target }: Props<T>) => {
    ...
    properties: {
      layout: {
        ...
        properties: {
          ...
          terms2: createGroup(
            intl.formatMessage({
              id: 'component.search.label.secondGroup',
              defaultMessage: '第二组',
            }),
          ),
        },
              ...
              <Popconfirm
                onConfirm={async () => {
                  ...
                  if (response.status === 200) {
                    message.success(
                      intl.formatMessage({
                        id: 'component.search.option.success',
                        defaultMessage: '操作成功',
                      }),
                    );
                ...
                title={intl.formatMessage({
                  id: 'component.search.option.remove.tips',
  ...
  const handleSaveLog = async () => {
    ...
    if (response.status === 200) {
      message.success(
        intl.formatMessage({
          id: 'component.search.option.save.success.tips',
          defaultMessage: '保存成功',
        }),
      );
    } else {
      message.success(
        intl.formatMessage({
          id: 'component.search.option.save.error.tips',
          defaultMessage: '保存失败',
        }),
      );
    }
      ...
      <Form form={form} labelCol={4} wrapperCol={18}>
        ...
        <div className={styles.action}>
          <FormButtonGroup.FormItem labelCol={10} wrapperCol={14}>
            ...
            >
              {intl.formatMessage({
                id: 'component.search.option.search',
                defaultMessage: '搜索',
              })}
            </Dropdown.Button>
            <Popover
              content={
                <>
                  ...
                  <Button onClick={handleSaveLog} type="primary" className={styles.saveLog}>
                    {intl.formatMessage({
                      id: 'component.search.option.save',
                      defaultMessage: '保存',
                    })}
                  </Button>
                </>
              ...
              title={intl.formatMessage({
                id: 'component.search.label.searchName',
                defaultMessage: '搜索名称',
              })}
              trigger="click"
            >
            ...
            <Button block>
              {intl.formatMessage({
                id: 'component.search.option.reset',
                defaultMessage: '重置',
              })}
            </Button>
