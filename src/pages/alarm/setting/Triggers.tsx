...
import {AutoComplete, Card, Col, Icon, Input, Popconfirm, Row, Select,Button} from 'antd';
    ...
    switch (triggerType) {
            ...
            <Col span={24}>
              {filters.map((item: any, index) => (
                <div className="ant-row">
                  ...
                  <Col span={5} style={{textAlign: 'right', paddingBottom: 10}}>
                    <Button type="link"style={{paddingLeft: 10, paddingTop: 7}}
                       onClick={() => {
      ...
      case 'timer':
        return (
          <div>
            <Col span={24}>
            <Col span={12} style={{paddingBottom: 10,paddingLeft:0}}>
              ...
              <Col span={12} style={{paddingBottom: 10, paddingLeft: -1, paddingRight: 0}}>
                <Select placeholder="选择类型，如：属性/事件" defaultValue={trigger.type}
                        onChange={(value: string) => {
                          setMessageType(() => value);
                          trigger.type = value;
            ...
            {triggerType === 'timer' && messageType === 'function' && (
              <Col span={24} style={{backgroundColor: '#rgba(0, 0, 0, 0.45)', paddingBottom: 10}}>
      ...
      <Card size="small" bordered={false} style={{backgroundColor: 'rgb(250 250 250)'}}>
        <Row style={{marginLeft: -2}}>
          ...
          >
            ...
            <Button type="link" style={{position:'relative',left:450}}
                       onClick={() => {
                       }}><DeleteOutlined  /></Button>
          </Popconfirm>
        </Row>

        <Row gutter={16} style={{position:'relative',right:'10px'}}>
