...
class GaugeCharts extends React.Component<IGaugeProps> {
      ...
      <Chart height={height} data={data} scale={cols} padding={[26, 0, 0, 0]} forceFit>
        ...
        <Guide>
          <Arc
            ...
            style={{ // 底灰色
              stroke: `l (270) 0.25:rgba(36, 178, 118, 1) 0.5:rgba(66, 147, 255, 1)  0.75:rgba(250, 178, 71, 1) 1:rgba(66, 147, 255, 1)`,
              lineWidth: 10,
            }}
          />
          {val >= 5 && <Arc
...
export default autoHeight()(GaugeCharts);
