export default {
  ...
  link: [{
    ...
    "children": [{
      ...
      "buttons": [{"id": "add", "name": "新增", "enabled": false, "granted": true}, {
        "id": "update",
        "name": "编辑",
        "enabled": false,
        "granted": true
      ...
      "icon": "icon-rizhifuwu",
      "url": "/iot/link/Certificate",
      "buttons": [{"id": "delete", "name": "删除", "enabled": false, "granted": true}, {
        "id": "update",
        "name": "编辑",
        "enabled": false,
        "granted": true
      ...
      "children": [{
        ...
        "icon": "icon-zhilianshebei",
        "url": "/iot/link/Channel/Opcua",
        "buttons": [{"id": "view", "name": "设备接入", "enabled": false, "granted": true}, {
          "id": "action",
          "name": "启/禁用",
          "enabled": false,
          "granted": true
        ...
        "icon": "icon-changjingliandong",
        "url": "/iot/link/Channel/Modbus",
        "buttons": [{"id": "update", "name": "编辑", "enabled": false, "granted": true}, {
          "id": "action",
          "name": "启/禁用",
          "enabled": false,
          "granted": true
