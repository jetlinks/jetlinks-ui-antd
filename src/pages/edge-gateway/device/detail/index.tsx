    ...
    const content = {
        info: <div>
            <Descriptions bordered>
                ...
                <Descriptions.Item label="创建时间">{moment(info.createTime).format('YYYY-MM-DD HH:mm:ss')}</Descriptions.Item>
                <Descriptions.Item label="注册时间">{info.state?.value !== 'notActive' ? moment(info.registerTime).format('YYYY-MM-DD HH:mm:ss') : '/'}</Descriptions.Item>
                <Descriptions.Item label="最后上线时间">{info.state?.value !== 'notActive' ? moment(info.onlineTime).format('YYYY-MM-DD HH:mm:ss') : '/'}</Descriptions.Item>
