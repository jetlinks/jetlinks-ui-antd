...
import { Card, Table, Divider, Button, message, Modal, Badge, Icon, Upload, Popconfirm } from "antd";
            ...
            },
            {
                ...
                render: (record: DeviceProduct) => (
                    <Fragment>
                        ...
                        {
                            record.state === 0 ?
                                <Popconfirm title="确认发布？" onConfirm={() => { changeDeploy('deploy', record) }}>
                                    <a >发布</a>
                                </Popconfirm>
                                :
                                <Popconfirm title="确认停用" onConfirm={() => { changeDeploy('cancelDeploy', record) }}>
                                    <a >停用</a>
                                </Popconfirm>
                        }
                        <Divider type="vertical" />
                        <a onClick={() => { downloadObject(record, '设备型号') }}>下载配置</a>
                    </Fragment>
                ),
            },
        ];
