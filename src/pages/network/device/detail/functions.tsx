    ...
    return (
        <div>
            <Spin spinning={spinning}>
                <div style={{fontSize: '16px', fontWeight: 600, margin: '16px 0px'}}>功能调试</div>
                <Form layout="vertical">
                    <div style={{display: 'flex', justifyContent: 'space-around', width: '100%', alignItems: 'center'}}>
                            ...
                            <Form.Item label="参数：">
                                {getFieldDecorator('functionData', {
                                    ...
                                    <AceEditor
                                        ...
                                        style={{ width: '100%', height: 300, border: '1px solid lightgray' }}
                                        setOptions={{
                        ...
                        <div style={{ width: '50px', margin: '0px 10px 0px 25px' }}>
                            <Button icon="right" type="primary" onClick={() => {
                                debugFunction();
                            }}></Button>
                        </div>
                        <div style={{width: 'calc(52% - 80px)'}}>
                            <Form.Item label="调试结果：" style={{ paddingTop: 20 }}>
                                {getFieldDecorator('logs', {})(
                                    <Input.TextArea rows={18} readOnly />
                                )}
                            </Form.Item>
                        </div>
                    </div>
