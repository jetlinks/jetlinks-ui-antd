...
import Add from '@/pages/edge-gateway/device/detail/network/composit-gateway/save/addNetwork';
        ...
        <Modal
            ...
            onOk={() => {
                form.validateFields((err, fileValue) => {
                    if (err) return;
                    let params = {
                        id: data.id || `material${Math.round(Math.random() * 10000000000)}`,
                        name: product.name,
                        product: product,
                        network: network,
                        protocol: protocol,
        ...
        >
            <div style={{ margin: '0px 20px' }}>
                <Form layout="vertical">
                    ...
                    {dataType !== '' && (
                        <div style={{ margin: '0px 0px 18px 0px', width: '100%' }}>
