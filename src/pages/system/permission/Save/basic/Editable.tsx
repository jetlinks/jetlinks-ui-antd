import { Table, Input, Popconfirm, Form, Divider, message, Icon, Select, Tag, Radio } from 'antd';
...
const EditableCell: React.FC = (props: any) => {
    ...
    const getInput = () => {
        ...
        let selectOption = [];
        for (let [key, value] of supportDataAccessTypeMap) {
            ...
            {editing ? (
                <Form.Item style={{ margin: 0 }}>
                    {getFieldDecorator(dataIndex, {
                        rules: [
                            {
                                required: dataIndex === 'properties.supportDataAccess' ? false : true,
                                message: `请输入 ${title}!`,
                            },
                        ],
            ...
            render: (text: any, record: any) => {
                ...
                return editable ? (
                    <span>
                        {
                            <a
                                onClick={() => save(props.form, record.action)}
                                style={{ marginRight: 8 }}
                            >
                                保存
                                </a>
