...
const Member = observer(() => {
  ...
  const columns: ProColumns<TenantMember>[] = [
    ...
    {
      title: intl.formatMessage({
        id: 'pages.system.tenant.administrator',
        defaultMessage: '管理员',
      }),
  ...
  return (
    <Row gutter={[16, 16]}>
      <Col span={TenantModel.bind ? 12 : 24}>
        <Card
          title={intl.formatMessage({
            id: 'pages.system.tenant.tenantMember',
            defaultMessage: '租户成员',
          })}
        >
          <ProTable
            ...
            tableAlertOptionRender={() => (
              <Space size={16}>
                <a onClick={handleUnBind}>
                  {intl.formatMessage({
                    id: 'pages.system.tenant.unbinds',
                    defaultMessage: '批量解绑',
                  })}
                </a>
              </Space>
            ...
            toolBarRender={() => [
              ...
              >
                {intl.formatMessage({
                  id: 'pages.system.tenant.bindUser',
                  defaultMessage: '绑定用户',
                })}
              </Button>,
            ]}
      ...
      {TenantModel.bind && (
        <Col span={12}>
          <Card
            title={intl.formatMessage({
              id: 'pages.system.tenant.addUser',
              defaultMessage: '添加用户',
            })}
            extra={
              <CloseOutlined
