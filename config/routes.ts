    ...
    routes: [
      {
        ...
        routes: [
          ...
          },
          {
            ...
            icon: 'cloud',
            version: 'pro',
            authority: ['dueros-product', 'aliyun-bridge', 'onenet-product', 'ctwing-product', 'onelink-product', 'unicomCmp', ' onelink', 'ctwingCmp'],
            routes: [
              {
                path: '/cloud/duer',
                name: 'DuerOS',
          ...
          },
          {
            ...
            tenant: ['admin', 'member'],
            iconfont: 'icon-guizeyinqing',
            authority: ['network-card', 'network-flow'],
            routes: [
              {
